...
export const HOMEFORT_STATIC_CATEGORIES = {
  ...
  toppers: { key: 'toppers', name: 'Топери та наматрацники', h1: 'Топери та наматрацники', seoTitle: 'Топери та наматрацники — купити | DOMERA', seoDescription: 'Каталог топерів та наматрацників DOMERA.', canonicalUrl: '/catalog/toppers', indexable: true },
...
// Product inventory is intentionally empty. Category metadata stays intact so
// the catalog structure/design can remain in place until a new inventory is added.
