...
function AvailabilityBadge({ children }) {
  return (
    <span className="inline-flex min-h-[23px] items-center rounded-[7px] border border-[#ddd0c4]/75 bg-[#fffdf9]/94 px-2 py-0.5 text-[9px] font-normal leading-none tracking-[0.01em] text-[#665b52] shadow-[0_1px_7px_rgba(53,37,26,0.03)] backdrop-blur-md md:text-[10px]">
      {children}
    </span>
  );
}
